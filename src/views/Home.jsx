    ...
    <>
      <div className="flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center h-screen">
          ...
          <p className="text-lg">Here you can visualize and conceptualize your goals.<Link className="underline decoration-solid cursor-pointer ml-1 hover:opacity-70" to="/addGoals">Add goal now? </Link></p>
          <div className="flex gap-6 mt-10"><button onClick={scrollToVisual} className="text-sm underline hover:opacity-70 transition">↓ Scroll to Visual List</button>
            <button onClick={scrollToMaster} className="text-sm underline hover:opacity-70 transition">↓ Scroll to Master List</button>
          </div>
        </div>
        ...
        <div className="container grid grid-cols-16 min-w-screen bg-primary text-background">
        ...
        <div className="container grid grid-cols-16 min-w-screen">
          <div className="col-start-3 col-span-12">
            <div ref={nextSectionMas} className="min-h-screen p-8">
              ...
              <table className="table-auto w-full text-left">
                ...
                <tbody className="text-lg">
                  <tr>
                    ...
                    <td className="border-t-3 px-4 py-2">2023-12-31</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t-1 px-4 py-2">2023-02-01</td>
                    <td className="border-t-1 px-4 py-2">2023-10-31</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t-1 px-4 py-2">2023-03-01</td>
                    <td className="border-t-1 px-4 py-2">2023-12-31</td>
